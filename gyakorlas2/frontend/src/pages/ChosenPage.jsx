...
import ohlogo from '/images/logo.png'
import tajekoztatoKep from '/images/e-mail-marketing-2745489__340.jpg'
...
function ChosenPage() {
    ...
    const { id } = useParams()
    axios.get("http://localhost:3001/SubjectStudnent/" + id)
      .then((response) => {
      ...
      axios.get("http://localhost:3001/NyekStudnent/" + id)
      .then((response) => {
  ...
  return (
    <>
     <Container>
        ...
        <Row>
        {nyek.map((nyekegy) => (
            <h4>A felvettek névsora, {nyekegy.elokeszito}.
            A maximálisan felvehető tanulók száma: {nyekegy.helyekszama} fő.
            A választott ágazat: {nyekegy.agazat}.</h4>
        ))}
